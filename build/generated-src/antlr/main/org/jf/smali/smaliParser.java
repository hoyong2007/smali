// $ANTLR 3.5.2 smaliParser.g 2017-10-21 15:37:48
...
public class smaliParser extends Parser {
	...
	public final smaliParser.smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method, super_spec, implements_spec, class_spec, source_spec, field
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: literal, member_name, annotation, access_list, nonvoid_type_descriptor
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final smaliParser.statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: registers_directive, parameter_directive, catch_directive, ordered_method_item, catchall_directive
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, name, nonvoid_type_descriptor, signature, NULL_LITERAL
	...
	public final smaliParser.insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: register_list, INSTRUCTION_FORMAT45cc_METHOD, method_prototype, method_reference
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
